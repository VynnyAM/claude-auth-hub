...
DROP POLICY IF EXISTS "Only system can update roles" ON public.user_roles;
DROP POLICY IF EXISTS "Only system can delete roles" ON public.user_roles;
...
DROP POLICY IF EXISTS "Only system can delete subscriptions" ON public.subscriptions;
...
DROP POLICY IF EXISTS "Users with valid subscription can view own genograms" ON public.genograms;
DROP POLICY IF EXISTS "Users with valid subscription can insert own genograms" ON public.genograms;
DROP POLICY IF EXISTS "Users with valid subscription can update own genograms" ON public.genograms;
DROP POLICY IF EXISTS "Users with valid subscription can delete own genograms" ON public.genograms;
...
DROP POLICY IF EXISTS "Users with valid subscription can view elements of own genograms" ON public.genogram_elements;
DROP POLICY IF EXISTS "Users with valid subscription can insert elements to own genograms" ON public.genogram_elements;
DROP POLICY IF EXISTS "Users with valid subscription can update elements of own genograms" ON public.genogram_elements;
DROP POLICY IF EXISTS "Users with valid subscription can delete elements of own genograms" ON public.genogram_elements;
